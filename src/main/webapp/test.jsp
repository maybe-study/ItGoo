...
<script>
   ...
   var $dogList=$("#dogList").append($div1);
   var $div1=$('<div class="col-md-4 mb-3 mb-md-0">').append($div2);
   var $div2=$('<div class="card py-4 h-100">').append($div3);
   var $div3=$('<div class="card-body text-center">').append($('<i class="fas fa-mobile-alt text-primary mb-2">')).append($('<h4 class="text-uppercase m-0">').text('asdfasfddsafsdafsafsdaf')).append($('<hr class="my-4">')).append($('<div class="small text-black-50">').text('내용이 어ㅉㄱ'));
   /* $div3.append($('<h4 class="text-uppercase m-0">').text('asdfasfddsafsdafsafsdaf'));
   $div3.append($('<hr class="my-4">'));
   $div3.append($('<div class="small text-black-50">').text('내용이 어ㅉㄱ'));
          */
