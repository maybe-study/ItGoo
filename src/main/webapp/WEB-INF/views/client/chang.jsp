...
<style>
.wrapper, .dog .ears::before, .dog .ears::after, .dog .face::before, .dog .face::after, .dog .eyes, .dog .teardrop, .dog .nose, .dog .mouth, .dog .tongue::before, .dog .tongue::after, .dog .chin, .dog .tail, .btn {
...
.dog .mouth::before {
  -webkit-transform: translateX(-89%) rotate(45deg);
...
.btn-dislike .heart::before, .btn-dislike .heart::after {
...
.btn-like:hover ~ .wrapper .eyes::before, .btn-like:hover ~ .wrapper .eyes::after,
...
.btn-dislike:active ~ .wrapper .ears::before {
  -webkit-transform: rotate(-50deg) translate(-7px, 2px);
...
.btn-dislike:hover ~ .wrapper .eyes::before, .btn-dislike:hover ~ .wrapper .eyes::after,
