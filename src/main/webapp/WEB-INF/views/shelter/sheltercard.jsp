				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<li class="sub-menu"><a class="active" href="javascript:;">
						...
						<ul class="sub">
							...
							<li class="active"><a href="sheltercard">사업자등록증</a></li>
        ...
        *********************************************************************************************************************************************************** -->
		...
		<section id="main-content">
			<section class="wrapper">
				<h3>
					<i class="fa fa-angle-right"></i> 보호소 사업자 등록증 변경
				</h3>
				<!-- BASIC FORM ELELEMNTS -->
				<form
					action="updatecompanycardpic?${_csrf.parameterName}=${_csrf.token}"
											...
											<table class="file-table">
												...
												<tr class="file-table">
													...
													<td><input class="box" type="file" name="files"
														id="files" accept=".jpg,.jpeg,.png,.gif,.bmp">
