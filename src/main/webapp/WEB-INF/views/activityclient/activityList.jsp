...
<div id="articleView_layer">
	...
	$.each(atList, function(idx,data){
		...
		var $activitydetailbtn = $("<input type='button' id='activitydetailbtn' class='myButton' onclick=\"articleView("+data.activitynum+")\" value='예약하기' />")
		...
		var $classcardbodydiv = $("<div class='card-body'>").append($h3tag).append($explanation).append($price).append($activitydetailbtn);
