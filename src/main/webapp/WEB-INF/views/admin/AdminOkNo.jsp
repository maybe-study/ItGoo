...
<body>
						...
						<section class="panel">
							<div class="panel-body">
								<ul class="nav nav-pills nav-stacked labels-info ">
									...
									<li><img src="img/test.png" style="max-width: 100%">
									</li>
								</ul>
	...
	<script>
		...
		$("<input>").attr("type", 'hidden').attr("name", "companyid").attr(
				"value", data.companyid).appendTo("#frm");
		$("<input>").attr("type", 'hidden').attr("name", "companykind").attr(
				"value", data.companykind).appendTo("#frm");
